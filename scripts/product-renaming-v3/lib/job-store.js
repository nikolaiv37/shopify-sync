/**
 * Job-folder layout and atomic read/write helpers for product-renaming V3.
 *
 * V3 jobs live under logs/product-renaming-v3/jobs/<jobId>/ — separate from
 * V2 so a V3 run can never collide with an in-progress V2 run.
 *
 * Files in a V3 job:
 ...
 *   plan.json                      — per-item replacement plan
 ...
 *   needs-review.csv               — multiple/ambiguous/unsafe replacements
...
const ROOT = path.join('logs', 'product-renaming-v3', 'jobs');
...
export const FILES = {
  ...
  readyCsv: 'ready.csv',
  skippedAlreadyRenamedCsv: 'skipped-already-renamed.csv',
  skippedNoModelCsv: 'skipped-no-model.csv',
